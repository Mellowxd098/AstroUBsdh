...
from astro.plugins.sql.filter_sql import (
    add_filter,
    get_all_filters,
    remove_all_filters,
    remove_filter,
...
@astro.on(admin_cmd(pattern="savefilter (.*)"))
@astro.on(sudo_cmd(pattern="savefilter (.*)", allow_sudo=True))
...
@astro.on(admin_cmd(pattern="listfilters"))
@astro.on(sudo_cmd(pattern="listfilters", allow_sudo=True))
...
@astro.on(admin_cmd(pattern="clearfilter (.*)"))
@astro.on(sudo_cmd(pattern="clearfilter (.*)", allow_sudo=True))
...
@astro.on(admin_cmd(pattern="clearallfilters"))
@astro.on(sudo_cmd(pattern="clearallfilters", allow_sudo=True))
