...
@astro.on(admin_cmd(pattern="fstat ?(.*)"))
@astro.on(sudo_cmd(pattern="fstat ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@astro.on(admin_cmd(pattern="fedinfo ?(.*)"))
@astro.on(sudo_cmd(pattern="fedinfo ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
