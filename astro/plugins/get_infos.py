...
@astro.on(admin_cmd(pattern="get_ad?(m)in ?(.*)"))
@astro.on(sudo_cmd(pattern="get_ad?(m)in ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@astro.on(admin_cmd(pattern="get_id"))
@astro.on(sudo_cmd(pattern="get_id", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if event.reply_to_msg_id:
...
@astro.on(admin_cmd(pattern="get_bot ?(.*)"))
@astro.on(sudo_cmd(pattern="get_bot ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
