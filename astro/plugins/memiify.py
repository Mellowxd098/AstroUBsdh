...
from astro import CMD_HELP, TEMP_DOWNLOAD_DIRECTORY, bot
...
async def draw_meme(image_path, text):
    ...
    m_font = ImageFont.truetype(
        "resources/font.ttf", int((70 / 640) * i_width)
    )
    if ";" in text:
        upper_text, lower_text = text.split(";")
    else:
