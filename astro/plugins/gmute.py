...
from astro.plugins.sql.mute_sql import is_muted, mute, unmute
from astro.utils import admin_cmd


@astro.on(admin_cmd(outgoing=True, pattern=r"gmute ?(\d+)?"))
@astro.on(sudo_cmd(allow_sudo=True, pattern=r"gmute ?(\d+)?"))
...
@astro.on(admin_cmd(outgoing=True, pattern=r"ungmute ?(\d+)?"))
@astro.on(sudo_cmd(allow_sudo=True, pattern=r"ungmute ?(\d+)?"))
